        ...
        <div class="row ">
            <div class="col-md-4">
                <figure class="figure">
                    ...
                    <figcaption class="figure-caption text-center fw-bold text-uppercase pseudo"><?= $user['nickname']; ?></figcaption>
                </figure>
            </div>
            ...
            <div class="col-md-6 mt-5">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                    <button type="button" class="btn text-white btnProfil" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $user['id'] ?>">Voir profil !</button>
                ...
                <div class="modal fade" id="exampleModal<?= $user['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title text-uppercase " id="exampleModalLabel"><?= $user['nickname']; ?></h5>
