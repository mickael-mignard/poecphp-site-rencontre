        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <a class="btn border-dark mb-3 mr-1" href="#carouselExampleIndicators2" role="button"
                        data-bs-slide="prev">
                        <i class="fa fa-arrow-left"></i>
                    </a>
                    <a class="btn border-dark mb-3 " href="#carouselExampleIndicators2" role="button"
                        data-bs-slide="next">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3 boxShadow">
                                        <div class="card h-100">
                                            <h4 class="text-center pt-2"><img class="img imgTestimonial img-thumbnail shadow p-3 mb-5 bg-black rounded" alt="photo chien et chat"
                                                    src="assets/img/doudou&plumy.jpg">
                                            </h4>
                                            <div class="card-body">
                                    ...
                                    <div class="col-md-4 mb-3 boxShadow">
                                        <div class="card h-100">
                                            <h4 class="text-center pt-2"><img class="img imgTestimonial img-thumbnail shadow p-3 mb-5 bg-black rounded" alt="100%x280"
                                                    src="assets/img/Rex&Mangoust.jpg">
                                            </h4>
                                            <div class="card-body">
                                                <h5 class="card-title">
                                    ...
                                    <div class="col-md-4 mb-3 boxShadow">
                                        <div class="card h-100">
                                            <h4 class="text-center pt-2"> <img class="img imgTestimonial img-thumbnail shadow p-3 mb-5 bg-black rounded" alt="100%x280"
                                                    src="assets/img/FluffyBunny.jpg">
                                            </h4>
                                            <div class="card-body">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3 boxShadow">
                                        <div class="card h-100">
                                            <h4 class="text-center pt-2"><img class="img imgTestimonial img-thumbnail shadow p-3 mb-5 bg-black rounded" alt="100%x280"
                                                    src="assets/img/VanilleCaramel.jpg">
                                            </h4>
                                            <div class="card-body">
                                    ...
                                    <div class="col-md-4 mb-3 boxShadow">
                                        <div class="card h-100">
                                            <h4 class="text-center pt-2"> <img class="img imgTestimonial img-thumbnail shadow p-3 mb-5 bg-black rounded"" alt="100%x280"
                                                    src="assets/img/pupuceRandom.jpg">
                                            </h4>
                                            <div class="card-body">
                                                <h5 class="card-title">
                                    ...
                                    <div class="col-md-4 mb-3 boxShadow">
                                        <div class="card h-100">
                                            <h4 class="text-center pt-2"><img class="img imgTestimonial img-thumbnail shadow p-3 mb-5 bg-black rounded" alt="100%x280"
                                                    src="assets/img/MelloBambou.jpg">
                                            </h4>
                                            <div class="card-body">
                                                <h5 class="card-title">
