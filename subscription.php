                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3 form-check"> 
                                ...
                                <label class="form-check-label" for="radio1">Un canidé</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios" value="felide">
                                <label class="form-check-label" for="radio1">Un félidé</label>
                            </div>
                        </div>  
                        <div class="mb-3 inputSexe">
                            <p>Vous vous considérez comme :</p>
                            <div>
                                <input class="form-check-input" type="radio" id="sexChoice1" name="sex" value="mâle">
                                <label for="sexChoice1">Mâle</label>
                            </div>
                            <div>
                                <input class="form-check-input" type="radio" id="sexChoice2" name="sex" value="female">
                                <label for="sexChoice2">Femelle</label>
                            </div>
                            <div>
                                <input class="form-check-input" type="radio" id="sexChoice3" name="sex" value="nonBinary">
